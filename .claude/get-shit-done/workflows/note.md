...
- **Global scope**: `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/notes/`)
...
2. Glob `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/notes/` — works in any directory
