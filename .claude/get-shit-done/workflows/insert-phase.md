...
```bash
INIT=$(node "/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
