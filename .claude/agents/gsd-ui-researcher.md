...
Use template from `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/jashia/Documents/1_Projects/larraes-kitchen/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
